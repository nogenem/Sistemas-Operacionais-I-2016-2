...
${OBJECTDIR}/ModuleAssign.o: ModuleAssign.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleAssign.o ModuleAssign.cpp
...
${OBJECTDIR}/ModuleDelay.o: ModuleDelay.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleDelay.o ModuleDelay.cpp
...
${OBJECTDIR}/ModuleDuplicate.o: ModuleDuplicate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleDuplicate.o ModuleDuplicate.cpp
...
${OBJECTDIR}/ModuleInvoke_SystemEvent.o: ModuleInvoke_SystemEvent.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleInvoke_SystemEvent.o ModuleInvoke_SystemEvent.cpp

${OBJECTDIR}/ModuleSignal.o: ModuleSignal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleSignal.o ModuleSignal.cpp

${OBJECTDIR}/ModuleWait.o: ModuleWait.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ModuleWait.o ModuleWait.cpp
